...
export const BENCHMARK_SCENARIOS = Object.freeze([
  ...
  ,{ id: "sierra_guarded_conflict", prompt: "Inspect the guarded lender-activity evidence conflict read-only and identify the affected deal, provenance, authority, and impact.", expectedDomain: "sierra", expectedTool: "sierra.guarded_conflict_intelligence" }
  ,{ id: "sierra_durable_diagnostic", prompt: "Run a durable cross-system diagnostic investigation across Sierra.", expectedDomain: "sierra", expectedTool: "sierra.diagnostic_investigation" }
  ,{ id: "sierra_evidence_graph", prompt: "Build the full deal truth evidence graph for SCA-77.", expectedDomain: "sierra", expectedTool: "sierra.evidence_graph" }
