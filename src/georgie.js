...
export function modelCreditBlock(error){const message=String(error instanceof Error?error.message:error||"");return /\b(?:no credits? remaining|insufficient[_ ]quota|billing quota|billing hard limit)\b/i.test(message);}
