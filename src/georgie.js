...
async function askGeorgieCore(input, history = [], context = "", { onTextDelta, modelOverride = null, routeOverride = null, attachmentParts = [] } = {}) {
  ...
  const route = routeOverride || intelligenceRoute(input);
