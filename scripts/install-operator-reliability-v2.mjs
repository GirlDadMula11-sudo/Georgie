...
patchFile("src/objective-worker.js", [
  ...
  source => source.replace('objective.attempts = Number(objective.attempts || 0) + 1;', 'objective.attempts = Number(objective.attempts || 0) + 1; objective.attemptsByStep = objective.attemptsByStep || {}; objective.recoveryTrail = Array.isArray(objective.recoveryTrail) ? objective.recoveryTrail : [];'),
  source => {
