...
const requiredMarkers = new Map([
  ...
  ["src/model-cost-governor.js", ["GEORGIE_MODEL_TOKENS_PER_REQUEST", "GEORGIE_MODEL_TOKENS_PER_HOUR", "GEORGIE_MODEL_TOKENS_PER_DAY", "georgie_model_spend_reserve", "productionFailClosed"]],
