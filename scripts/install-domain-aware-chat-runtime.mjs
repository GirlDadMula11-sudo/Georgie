...
const operationalMarker='const operational=Boolean(event.tool)||["plan_ready","tool_running","tool_complete","verification","repair_plan","planning_failed","plan_recovered"].includes(stage);';
