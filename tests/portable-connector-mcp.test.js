...
test("portable connector exposes five focused accurately annotated tools", () => {
  assert.deepEqual(GEORGIE_CONNECTOR_TOOLS.map((tool) => tool.name), ["georgie_dispatch_command", "georgie_forward_approval", "georgie_get_command", "georgie_mailbox_packet_manifests", "georgie_mailbox_evidence_packet"]);
