...
test("Mac agent performs a bounded Studio play test with six gameplay checks", () => {
  ...
  assert.ok(fileDialog.indexOf("open_keyboard_second_default_press") < fileDialog.indexOf("open_button_nested_scan"), "the bounded second native Open action must precede accessibility button discovery");
