...
test("unified runtime starts recurring SEO scheduler",()=>{const src=fs.readFileSync(new URL("../src/runtime.js",import.meta.url),"utf8");assert.match(src,/startSeoMonitorScheduler\(\)/);});
