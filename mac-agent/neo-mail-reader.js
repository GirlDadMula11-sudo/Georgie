...
function neoStartStaticContractInspection() {
  const state={status:"running",startedAt:new Date().toISOString(),bundles:[],contracts:[],stores:[],errors:[],credentialsTransferred:false,mailboxDataAccessed:false,mailboxInteractionPerformed:false};window.__georgieNeoStaticContracts=state;
